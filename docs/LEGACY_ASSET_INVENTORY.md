...
| Favicon de `shisha` | `/shisha/favicon.svg` | SVG | Media | Ligado a una SPA separada y fuera del contenido publico actual de SUBEROS | No aplica | No reutilizado ni promovido a produccion tras Sprint 05.1 | Rejected |
